...
def test_poll_service_integration():
    ...
    from friendly_computing_machine.models.poll import PollCreate, PollOptionCreate, PollVoteCreate
    ...
    from friendly_computing_machine.temporal.poll_workflow import PollWorkflowParams, PollUpdateActivityParams
...
def test_poll_command_handler_structure():
    ...
    import friendly_computing_machine.bot.handlers.commands
    import friendly_computing_machine.bot.handlers.views
    import friendly_computing_machine.bot.handlers.actions
